      ...
      <div class="card-body">
        ...
        <form class="forms-sample" method="POST" action="{{ route('setting.update') }}" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-6">
              <input type="file" class="form-control" id="favicon" name="favicon" value="{{ $setting->favicon }}">
            </div>
          </div>
          <div class="form-group row">
            <label for="header-logo" class="col-sm-3 col-form-label text-black text-end">Header logo</label>
            <div class="col-sm-6">
              <input type="file" class="form-control" id="header-logo" name="header_logo" value="{{ $setting->header_logo }}">
            </div>
          </div>
          <div class="form-group row">
            <label for="footer-logo" class="col-sm-3 col-form-label text-black text-end">Footer Logo</label>
            <div class="col-sm-6">
              <input type="file" class="form-control" id="footer-logo" name="footer_logo" value="{{ $setting->footer_logo }}">
            </div>
          </div>
          <div class="form-group row">
